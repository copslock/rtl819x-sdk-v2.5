...
//delete interface of bridge
	...
	sprintf(cmdBuffer,"echo \"%d %d %d %d %d %d %d %d\" > /proc/rtk_hw_vlan_support", voipCfgParam.vlan_enable, voipCfgParam.vlan_nat_tag, voipCfgParam.vlan_lan_0, voipCfgParam.vlan_lan_0_tag,voipCfgParam.vlan_lan_1, voipCfgParam.vlan_lan_1_tag,voipCfgParam.vlan_lan_2, voipCfgParam.vlan_lan_2_tag);
	system(cmdBuffer);

        sprintf(cmdBuffer,"echo \"%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\" > /proc/rtk_sw_vlan_support", voipCfgParam.sw_vlan_enable, voipCfgParam.sw_vlan_mgdata,voipCfgParam.sw_vlan_mgdata_pri, voipCfgParam.sw_vlan_voice,voipCfgParam.sw_vlan_voice_pri,  voipCfgParam.sw_vlan_wifi,voipCfgParam.sw_vlan_wifi_pri, voipCfgParam.sw_vlan_wifi_vap0,voipCfgParam.sw_vlan_wifi_vap0_pri, voipCfgParam.sw_vlan_wifi_vap1,voipCfgParam.sw_vlan_wifi_vap1_pri, voipCfgParam.sw_vlan_wifi_vap2,voipCfgParam.sw_vlan_wifi_vap2_pri, voipCfgParam.sw_vlan_wifi_vap3,voipCfgParam.sw_vlan_wifi_vap3_pri);
...
//				if(isFileExist(ETH_VLAN_SWITCH)){
					...
					if(
							...
							(vlan_enabled==0)&&(iface_name[3]=='2' || iface_name[3]=='3' || iface_name[3]=='4'
						#if defined(CONFIG_RTK_VLAN_NEW_FEATURE)
												|| iface_name[3]=='7'
						#endif
					))
